...
ActiveRecord::Schema.define(version: 20160624124527) do
  ...
  add_index "mentors", ["confirmation_token"], name: "index_mentors_on_confirmation_token", unique: true
  ...
  add_index "mentors", ["unlock_token"], name: "index_mentors_on_unlock_token", unique: true
